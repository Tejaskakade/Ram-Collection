...
public class MailMessage {
	public static void registrationSuccess(String emailId, String name) {
		...
		String htmlTextMessage = "" + "<html>" + "<body>"
				+ "<h2 style='color:green;'>Welcome to Ram Collection</h2>" + "" + "Hi " + name + ","
				+ "<br><br>Thanks for singing up with Ram Collection.<br>"
				+ "We are glad that you choose us. We invite you to check out our latest collection of new cloths."
				+ "<br>We are providing upto 60% OFF on most of our products. So please visit our site and explore the collections."
				+ "<br><br>Our Ram Collection is growing in a larger amount these days and we are in high demand so we thanks all of you for "
				...
				+ "to enter the promo code given below.<br><br><br> PROMO CODE: " + "RAMCOLL500<br><br><br>"
	...
	public static void transactionSuccess(String recipientEmail, String name, String transId, double transAmount) {
		...
		String subject = "Order Placed at Ram collection";
		String htmlTextMessage = "<html>" + "  <body>" + "    <p>" + "      Hey " + name + ",<br/><br/>"
				+ "      We are glad that you shop with Ram Collection!" + "      <br/><br/>"
				...
				+ "      Come Shop Again! <br/<br/> <font style=\"color:green;font-weight:bold;\">Ram Collection.</font>"
				+ "    </p>" + "    " + "  </body>" + "</html>";
	...
	public static void orderShipped(String recipientEmail, String name, String transId, double transAmount) {
		String recipient = recipientEmail;
		String subject = "Hurray!!, Your Order has been Shipped from Ram Collection";
		String htmlTextMessage = "<html>" + "  <body>" + "    <p>" + "      Hey " + name + ",<br/><br/>"
				+ "      We are glad that you shop with Ram Collection!" + "      <br/><br/>"
	...
	public static void productAvailableNow(String recipientEmail, String name, String prodName, String prodId) {
		String recipient = recipientEmail;
		String subject = "Product " + prodName + " is Now Available at Ram Collection";
		String htmlTextMessage = "<html>" + "  <body>" + "    <p>" + "      Hey " + name + ",<br/><br/>"
				+ "      We are glad that you shop with Ram Collection!" + "      <br/><br/>"
				...
				+ "      Come Shop Again! <br/<br/><br/> <font style=\"color:green;font-weight:bold;\">Ram Collection.</font>"
				+ "    </p>" + "    " + "  </body>" + "</html>";
