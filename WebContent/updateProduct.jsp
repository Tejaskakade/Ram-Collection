				...
				<div class="row">
					...
					<div class="col-md-6 form-group">
						...
						<label for="producttype">Product Type</label> <select name="type"
							...
							<option value="mens"
								<%="men".equalsIgnoreCase(ptype) ? "selected" : ""%>>Men</option>
							<option value="women"
								<%="women".equalsIgnoreCase(ptype) ? "selected" : ""%>>Women</option>
							<option value="children"
								<%="children".equalsIgnoreCase(ptype) ? "selected" : ""%>>Children</option>
							<option value="sport"
								<%="sport".equalsIgnoreCase(ptype) ? "selected" : ""%>>Sport</option>
							<%-- <option value="tablet"
