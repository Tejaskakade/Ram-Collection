...
<body style="background-color: #E6F9E6;">
	...
	<div class="container-fluid text-center"
		style="margin-top: 45px; background-color: #799351; color: white; padding: 5px;">
		<h2>Ram Collection</h2>
		<h6>"Chic Threads: Elevate Your Style with Our Exclusive Cloth Collection"</h6>
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				...
				<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="index.jsp?type=mens">Men</a></li>
							<li><a href="index.jsp?type=women">Women</a></li>
							<li><a href="index.jsp?type=children">Children</a></li>
							<li><a href="index.jsp?type=sport">Sport</a></li>
							<li><a href="index.jsp?type=all">All</a></li>
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="userHome.jsp?type=mens">Men</a></li>
							<li><a href="userHome.jsp?type=women">Women</a></li>
							<li><a href="userHome.jsp?type=children">Children</a></li>
							<li><a href="userHome.jsp?type=sport">Sport</a></li>
							<li><a href="userHome.jsp?type=all">All</a></li>
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="adminViewProduct.jsp?type=mens">Men</a></li>
							<li><a href="adminViewProduct.jsp?type=women">Women</a></li>
							<li><a href="adminViewProduct.jsp?type=children">Children</a></li>
							<li><a href="adminViewProduct.jsp?type=sport">Sport</a></li>
